...
{
    public class BlacklisitngControllerTest : IClassFixture<CustomWebApplicationFactory>
    {
        private readonly CustomWebApplicationFactory _factory;

        public BlacklisitngControllerTest(CustomWebApplicationFactory factory)
        {
            _factory = factory;
        }
