...
{
    public class whitelistingControllerTest : IClassFixture<CustomWebApplicationFactory>
    {
        private readonly CustomWebApplicationFactory _factory;

        public whitelistingControllerTest(CustomWebApplicationFactory factory)
        {
            _factory = factory;
        }
