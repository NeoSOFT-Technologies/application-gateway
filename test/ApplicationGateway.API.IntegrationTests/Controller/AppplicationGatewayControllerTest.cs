...
{
    public class AppplicationGatewayControllerTest : IClassFixture<CustomWebApplicationFactory>
    {
        private readonly CustomWebApplicationFactory _factory;

        public AppplicationGatewayControllerTest(CustomWebApplicationFactory factory)
        {
            _factory = factory;
        }
