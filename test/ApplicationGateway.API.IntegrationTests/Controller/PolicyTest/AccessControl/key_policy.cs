...
{
    [Collection("Database")]
    public class key_policy : IClassFixture<CustomWebApplicationFactory>
    {
        private readonly CustomWebApplicationFactory _factory;
        private HttpClient client = null;
        public key_policy(CustomWebApplicationFactory factory)
        {
            _factory = factory;
        ...
        [Fact]
        public async Task CreateKeyMultiplePolicy()
        {
            ...
            {
                var mypolicyJsonString = File.ReadAllText(ApplicationConstants.BASE_PATH + "/PolicyData/AccessControls/keymultiplepolicy.json");
