...
{
    public class PolicyThrottlingTest : IClassFixture<CustomWebApplicationFactory>
    {
        private readonly CustomWebApplicationFactory _factory;

        public PolicyThrottlingTest(CustomWebApplicationFactory factory)
        {
            _factory = factory;
        }
        ...
        public async Task Add_policy_with_Throttling_returnSuccess()
        {
            ...
            //create policy
            var mypolicyJsonString = File.ReadAllText(ApplicationConstants.BASE_PATH + "/PolicyData/CreatePolicy-Throttling.json");
        ...
        public async Task Add_policy_with_Api_Throttling_returnSuccess()
        {
            ...
            //create policy
            var mypolicyJsonString = File.ReadAllText(ApplicationConstants.BASE_PATH + "/PolicyData/CreatePolicy-Api_Throttling.json");
            JObject keyValues = JObject.Parse(mypolicyJsonString);
            keyValues["name"] = Guid.NewGuid().ToString();
            foreach (var obj in keyValues["apIs"])
            {
