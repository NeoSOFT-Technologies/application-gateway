...
{
    public class LoadBalancingControllerTest : IClassFixture<CustomWebApplicationFactory>
    {
        private readonly CustomWebApplicationFactory _factory;

        public LoadBalancingControllerTest(CustomWebApplicationFactory factory)
        {
            _factory = factory;
        }
